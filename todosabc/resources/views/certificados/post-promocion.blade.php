...
if($oferta->id == 3){
	$equivalencia = 'TERCERO Y CUARTO GRADOS';
}else if($oferta->id == 4){
	$equivalencia = 'QUINTO Y SEXTO GRADOS';
}else{
	$equivalencia = 'SÉPTIMO GRADO';
}
echo "<p style='text-align: justify;margin-top: 0;'><span style='font-weight:bold;'>del $equivalencia DE EDUCACIÓN GENERAL BÁSICA,</span> obtuvo las siguientes calificaciones durante el presente periodo educativo.</p>";
echo "<br>";
echo "<center>";
...
if($oferta->id == 3){
	$promocion = 'QUINTO GRADO';
	echo "<p style='text-align: justify;'>Por lo tanto, es promovido/a al: $promocion DE EDUCACIÓN GENERAL BÁSICA. Para certificar suscriben en unidad ";
	echo "de acto el/la Director/a – Rector/a con el/la Secretario/a General del Plantel o ";
	echo "Profesor/a de Grado.</p>";
}else if($oferta->id == 4){
	$promocion = 'SÉPTIMO GRADO';
	echo "<p style='text-align: justify;'>Por lo tanto, es promovido/a al: $promocion DE EDUCACIÓN GENERAL BÁSICA. Para certificar suscriben en unidad ";
	echo "de acto el/la Director/a – Rector/a con el/la Secretario/a General del Plantel o ";
	echo "Profesor/a de Grado.</p>";
}else{
	$promocion = 'OCTAVO GRADO';
	echo "<p style='text-align: justify;'>Por lo tanto, es promovido/a al: $promocion DE EDUCACIÓN GENERAL BÁSICA. Para certificar suscriben en unidad de acto el/la Director/a – Rector/a ";
