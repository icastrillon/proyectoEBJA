...
<div class="container-fluid">
	...
	<table class="table table-condensed table-bordered">
		...
		<tr>
			...
			<td>
				<label>8vo - 9no - 10mo E.G.B.</label>
			</td>
			<td>
		...
		<tr>
			...
			<td colspan="2">
				<a href="{{ route('calificaciones_basica', ['descargar'=>'pdf-basica', 'bloque' => $id_materia_oferta, 'doc' => $docente->id, 'par' => $paralelo]) }}">
	...
	<form id="frm_guardar_basica" class="form-horizontal" method="POST" action="{{ route('guardarCalifBasica') }}">
		{{ csrf_field() }}
						...
						<tr>
							...
							<td>
								<table>
									<tr>
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="q1p1-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_pm_parciales_q1('{{ $mat->codigo_inscripcion }}');document.getElementById('hq1p1-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_1_parcial_1 }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
										...
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="q1p2-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_pm_parciales_q1('{{ $mat->codigo_inscripcion }}');document.getElementById('hq1p2-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_1_parcial_2 }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
										...
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="q1p3-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_pm_parciales_q1('{{ $mat->codigo_inscripcion }}');document.getElementById('hq1p3-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_1_parcial_3 }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
											<input type="hidden" name="hq1p3-{{ $mat->codigo_inscripcion }}" id="hq1p3-{{ $mat->codigo_inscripcion }}" value="{{ $mat->quimestre_1_parcial_3 }}">
										</td>
										<td>
											<input class="col-md-1 form-control basica-promedio" type="text" id="q1pmpar-{{ $mat->codigo_inscripcion }}" maxlength="5" disabled="true" value="{{ $mat->quimestre_1_promedio_parciales }}">
										...
										<td>
											<input class="col-md-1 form-control basica-promedio" type="text" id="q1pmgpar-{{ $mat->codigo_inscripcion }}" maxlength="5" style="font-weight: bold !important;" value="{{ bcdiv($mat->quimestre_1_promedio_parciales * 0.80,'1',2) }}" disabled="true">
										</td>
										<td>
											<input class="col-md-1 form-control basica-examen" type="text" id="ex1-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_nota20_q1('{{ $mat->codigo_inscripcion }}');document.getElementById('hex1-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_1_examen }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
										...
										<td>
											<input class="col-md-1 form-control basica-examen" type="text" id="exs1-{{ $mat->codigo_inscripcion }}" maxlength="5" style="font-weight: bold !important;" value="{{ bcdiv($mat->quimestre_1_examen * 0.20,'1',2) }}" disabled="true">
										</td>
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="pmfq1-{{ $mat->codigo_inscripcion }}" maxlength="5" style="font-weight: bold !important;" value="{{ bcdiv($mat->quimestre_1_final,'1',2) }}" disabled="true">
							...
							<td>
								<table>
									<tr>
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="q2p1-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_pm_parciales_q2('{{ $mat->codigo_inscripcion }}');document.getElementById('hq2p1-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_2_parcial_1 }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
										...
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="q2p2-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_pm_parciales_q2('{{ $mat->codigo_inscripcion }}');document.getElementById('hq2p2-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_2_parcial_2 }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
										...
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="q2p3-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_pm_parciales_q2('{{ $mat->codigo_inscripcion }}');document.getElementById('hq2p3-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_2_parcial_3 }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
											<input type="hidden" name="hq2p3-{{ $mat->codigo_inscripcion }}" id="hq2p3-{{ $mat->codigo_inscripcion }}" value="{{ $mat->quimestre_2_parcial_3 }}">
										</td>
										<td>
											<input class="col-md-1 form-control basica-promedio" type="text" id="q2pmpar-{{ $mat->codigo_inscripcion }}" maxlength="5" disabled="true" value="{{ $mat->quimestre_2_promedio_parciales }}">
										...
										<td>
											<input class="col-md-1 form-control basica-promedio" type="text" id="q2pmgpar-{{ $mat->codigo_inscripcion }}" maxlength="5" style="font-weight: bold !important;" value="{{ bcdiv($mat->quimestre_2_promedio_parciales * 0.80,'1',2) }}" disabled="true">
										</td>
										<td>
											<input class="col-md-1 form-control basica-examen" type="text" id="ex2-{{ $mat->codigo_inscripcion }}" maxlength="5" onblur="calcular_nota20_q2('{{ $mat->codigo_inscripcion }}');document.getElementById('hex2-{{ $mat->codigo_inscripcion }}').value = this.value;" value="{{ $mat->quimestre_2_examen }}" 
											@if($mat->desertado==true)
												disabled="true" 
											@endif>
										...
										<td>
											<input class="col-md-1 form-control basica-examen" type="text" id="exs2-{{ $mat->codigo_inscripcion }}" maxlength="5" style="font-weight: bold !important;" value="{{ bcdiv($mat->quimestre_2_examen * 0.20,'1',2) }}" disabled="true">
										</td>
										<td>
											<input class="col-md-1 form-control nota-basica" type="text" id="pmfq2-{{ $mat->codigo_inscripcion }}" maxlength="5" style="font-weight: bold !important;" value="{{ bcdiv($mat->quimestre_2_final,'1',2) }}" disabled="true">
	...
	<button type="button" class="btn btn-primary" onclick="guardar_basica(event);">Guardar Calificaciones</button>
	@endif
	<a class="btn btn-default" href="{{ route('calificaciones_prebasica', ['token' => session('token')]) }}">Regresar</a>	
</div>
@endsection